...
u1c1=num2cell(data1.data.Circle(:,[1,3])',1);
u1t1=num2cell(data1.data.Triangle(:,[1,3])',1);
u1r1=num2cell(data1.data.Right(:,[1,3])',1);
u1d1=num2cell(data1.data.Down(:,[1,3])',1);
u1c2=num2cell(data1.data.Circle(:,[5,7])',1);
u1t2=num2cell(data1.data.Triangle(:,[5,7])',1);
u1r2=num2cell(data1.data.Right(:,[5,7])',1);
u1d2=num2cell(data1.data.Down(:,[5,7])',1);
u1c3=num2cell(data1.data.Circle(:,[9,11])',1);
u1t3=num2cell(data1.data.Triangle(:,[9,11])',1);
u1r3=num2cell(data1.data.Right(:,[9,11])',1);
u1d3=num2cell(data1.data.Down(:,[9,11])',1);
